# Generated by Django 3.2.13 on 2022-11-01 17:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('ruim', models.IntegerField(default=0)),
                ('ruim2', models.IntegerField(default=0)),
                ('ruim3', models.IntegerField(default=0)),
                ('ruim4', models.IntegerField(default=0)),
                ('ruim5', models.IntegerField(default=0)),
                ('ruim6', models.IntegerField(default=0)),
                ('ruim7', models.IntegerField(default=0)),
                ('ruim8', models.IntegerField(default=0)),
                ('ruim9', models.IntegerField(default=0)),
                ('bom', models.IntegerField(default=0)),
                ('bom2', models.IntegerField(default=0)),
                ('bom3', models.IntegerField(default=0)),
                ('bom4', models.IntegerField(default=0)),
                ('bom5', models.IntegerField(default=0)),
                ('bom6', models.IntegerField(default=0)),
                ('bom7', models.IntegerField(default=0)),
                ('bom8', models.IntegerField(default=0)),
                ('bom9', models.IntegerField(default=0)),
                ('medio', models.IntegerField(default=0)),
                ('medio2', models.IntegerField(default=0)),
                ('medio3', models.IntegerField(default=0)),
                ('medio4', models.IntegerField(default=0)),
                ('medio5', models.IntegerField(default=0)),
                ('medio6', models.IntegerField(default=0)),
                ('medio7', models.IntegerField(default=0)),
                ('medio8', models.IntegerField(default=0)),
                ('medio9', models.IntegerField(default=0)),
                ('excelente', models.IntegerField(default=0)),
                ('idProfessor', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='website.aluno')),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
