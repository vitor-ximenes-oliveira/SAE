# Generated by Django 3.2.13 on 2022-09-12 11:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity', models.CharField(choices=[('students', 'students'), ('teachers', 'teachers'), ('Admin', 'Admin')], max_length=20)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivelQuestao1', models.CharField(blank=True, max_length=100)),
                ('nivelQuestao2', models.CharField(blank=True, max_length=100)),
                ('nivelQuestao3', models.CharField(blank=True, max_length=100)),
                ('nivelQuestao4', models.CharField(blank=True, max_length=100)),
                ('nivelQuestao5', models.CharField(blank=True, max_length=100)),
                ('nivelQuestao6', models.CharField(blank=True, max_length=100)),
                ('nivelQuestao7', models.CharField(blank=True, max_length=100)),
                ('nivelQuestao8', models.CharField(blank=True, max_length=100)),
                ('nivelQuestao9', models.CharField(blank=True, max_length=100)),
                ('nivelQuestao10', models.CharField(blank=True, max_length=100)),
            ],
            options={
                'db_table': 'formulario',
            },
