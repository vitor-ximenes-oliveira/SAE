...
urlpatterns = [
    ...
    path('inserirTurma/<int:idProfessor>',views.inserirTurma,name='inserirTurma'),
    ...
    path('formularioAluno/<int:ra>', views.formularioAluno,name="formularioAluno"),
    url(r'^editarTurma/(?P<idProfessor>[0-9]*)',views.editarTurma,name="editarTurma"),
